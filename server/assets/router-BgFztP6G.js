...
const appCss = "/Bordado/assets/styles-if2xVon8.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Rodrigo Bordados" },
      { name: "description", content: "Bordados personalizados feitos à mão." },
      { name: "author", content: "Rodrigo Bordados" },
...
const $$splitComponentImporter = () => import("./index-Bk6zav31.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Bordados artesanais e personalizados: roupas, enxoval infantil e presentes únicos. Peça sua personalização pelo WhatsApp."
    }, {
      property: "og:title",
      content: "Rodrigo Bordados — Bordados que contam histórias"
    }, {
